package com.bangkit.acnetect.presentation.changepassword
...
import com.bangkit.acnetect.databinding.ActivityChangePasswordBinding
        ...
        changePasswordBinding.apply {
            when{
                ...
                confirmNewPass.length < 8 -> {
                    etConfirmNewPasswordChangePassword.error = getString(R.string.please_input_your_confirm_new_password_more_than_8)
                    etConfirmNewPasswordChangePassword.requestFocus()
                }
